...
namespace Servicio.Entities
{
    ...
    public partial class SHOECORP_BDEntities : DbContext
    {
        ...
        public virtual int ACTUALIZAR_USUARIO(Nullable<System.Guid> v_ID, string v_NAME, string v_FLASTNAME, string v_SLASTNAME, Nullable<int> iD_ROL, string pASSWORD, string tEL, string v_EMAIL, string v_PHOTO, string v_ADRESS)
        {
            ...
            return ((IObjectContextAdapter)this).ObjectContext.ExecuteFunction("ACTUALIZAR_USUARIO", v_IDParameter, v_NAMEParameter, v_FLASTNAMEParameter, v_SLASTNAMEParameter, iD_ROLParameter, pASSWORDParameter, tELParameter, v_EMAILParameter, v_PHOTOParameter, v_ADRESSParameter);
        }
